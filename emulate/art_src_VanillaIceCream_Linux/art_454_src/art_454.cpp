...
int main(int argc, char* argv[]){
    cout <<"==================================================================="<<endl;
    cout <<"                      ART_454 (Version 2.5.8)                      "<<endl; 
	...
	cout<<"#READ_PAIRS_PER_AMPLICON -  number of read pairs per amplicon (for two-end amplicon sequencing)"<<endl<<endl; 
        ...
        cout<<" 2) paired-end simulation with the mean fragment size 500 and STD 20 using GS FLX Titanium platform"<<endl;
...
*/
		       	sR.getCigar(aln[0],aln[1]);
			sR2.getCigar(aln2[0],aln2[1]);
